...
function buildLayer(){
 ...
 '<nav class="community-primary-tabs" aria-label="Feed da Comunidade"><button class="active" data-community-tab="for_you">Para você</button><button data-community-tab="following">Seguindo</button></nav>'+
