...
function buildLayer(){
 ...
 layer.innerHTML='<header class="community-mobile-header"><div class="community-feed-heading"><h1>Feed</h1></div><div><button data-community-mobile="search" aria-label="Pesquisar">'+icon('search')+'</button><button data-community-mobile="notifications" aria-label="Notificações">'+icon('bell')+'</button><button data-community-mobile="profile" class="community-mini-avatar" aria-label="Abrir meu perfil">N</button></div></header>'+
