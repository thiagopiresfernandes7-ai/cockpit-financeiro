const CACHE_NAME="norteia-v51";
const APP_SHELL=["./","./index.html","./financial-decision-engine.js","./freemium.js","./norteia-v2.css","./norteia-v2.js","./norteia-completion.css","./norteia-completion.js","./contrast.css","./norteia-design.css","./norteia-design.js","./gamification.css","./gamification.js","./manifest.json","./privacy-policy.html","./terms.html","./support.html","./delete-account.html","./premium.html","./hotmart-access.html","./legal.css","./icon-192.png","./icon-512.png","./maskable-icon-512.png","./apple-touch-icon.png","./assets/brand/norteia-icon.svg","./assets/brand/norteia-symbol.svg"];
